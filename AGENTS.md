...
Implement features and fix bugs with minimal regression risk, while preserving Velyx's architecture:
...
- Service/runtime wiring: `src/velyx/app/service.py`
- Memorize flow: `src/velyx/app/memorize.py`
- Retrieve flow: `src/velyx/app/retrieve.py`
- CRUD/Patch flow: `src/velyx/app/crud.py`
- Config models/defaults: `src/velyx/app/settings.py`
- Workflow engine: `src/velyx/workflow/*`
- Storage abstraction/factory: `src/velyx/database/interfaces.py`, `src/velyx/database/factory.py`
- In-memory: `src/velyx/database/inmemory/*`
- SQLite: `src/velyx/database/sqlite/*`
- Postgres: `src/velyx/database/postgres/*`
- LLM clients/wrappers/interceptors: `src/velyx/llm/*`
- Integrations: `src/velyx/integrations/*`, `src/velyx/client/*`
- Tests: `tests/*`
