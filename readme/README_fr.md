...
[![PyPI version](https://badge.fury.io/py/velyx-py.svg)](https://badge.fury.io/py/velyx-py)
[![License: Apache 2.0](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![Python 3.13+](https://img.shields.io/badge/python-3.13+-blue.svg)](https://www.python.org/downloads/)
[![Discord](https://img.shields.io/badge/Discord-Join%20Chat-5865F2?logo=discord&logoColor=white)](https://discord.gg/velyx)
...
Velyx est un framework de mémoire conçu pour les **agents proactifs 24/7**.
...
Velyx **capture et comprend continuellement l'intention de l'utilisateur**. Même sans commande, l'agent peut détecter ce que vous êtes sur le point de faire et agir de lui-même.

---

## 🤖 [OpenClaw (Moltbot, Clawdbot) Alternative](https://velyx.bot)

<img width="100%" src="https://github.com/velyx-AI/Velyx/blob/main/assets/velyxbot.png" />
...
Try now: [Velyx bot](https://velyx.bot)

---

## 🗃️ La Mémoire comme Système de Fichiers, le Système de Fichiers comme Mémoire

Velyx traite la **mémoire comme un système de fichiers**—structurée, hiérarchique et instantanément accessible.

| Système de Fichiers | Mémoire Velyx |
|--------------------|--------------|
...
Tout comme un système de fichiers transforme des octets bruts en données organisées, Velyx transforme les interactions brutes en **intelligence structurée, recherchable et proactive**.

---

## ⭐️ Mettez une étoile au dépôt

<img width="100%" src="https://github.com/velyx-AI/Velyx/blob/main/assets/star.gif" />
Si vous trouvez Velyx utile ou intéressant, une étoile GitHub ⭐️ serait grandement appréciée.
...
Velyx suit: historique de lecture, articles sauvegardés, requêtes de recherche
...
```python
# Velyx observe les patterns email au fil du temps:
...
```python
# Velyx apprend les préférences de trading:
...
Le système à trois couches de Velyx permet à la fois **les requêtes réactives** et **le chargement proactif de contexte** :
...
👉 **[velyx.so](https://velyx.so)** - Service hébergé avec apprentissage continu 7×24

Pour un déploiement entreprise avec des workflows proactifs personnalisés, contactez **info@velyx.ai**

#### API Cloud (v3)

| URL de Base | `https://api.velyx.so` |
|-------------|----------------------|
...
📚 **[Documentation Complète de l'API](https://velyx.pro/docs#cloud-version)**
...
Velyx supporte des fournisseurs LLM et embeddings personnalisés au-delà d'OpenAI. Configurez-les via `llm_profiles`:
```python
from velyx import velyxService

service = velyxService(
    llm_profiles={
...
Velyx supporte [OpenRouter](https://openrouter.ai) comme fournisseur de modèles, vous donnant accès à plusieurs fournisseurs LLM via une seule API.
...
Velyx supporte à la fois **le chargement proactif de contexte** et **les requêtes réactives**:
...
Velyx atteint **92.09% de précision moyenne** sur le benchmark Locomo à travers toutes les tâches de raisonnement, démontrant des opérations de mémoire proactive fiables.

<img width="100%" alt="benchmark" src="https://github.com/user-attachments/assets/6fec4884-94e5-4058-ad5c-baac3d7e76d9" />

Voir les données expérimentales détaillées: [Velyx-experiment](https://github.com/velyx-AI/Velyx-experiment)
...
|-------|-------------|---------------------------|
| **[Velyx](https://github.com/velyx-AI/Velyx)** | Moteur principal de mémoire proactive | Pipeline d'apprentissage 7×24, auto-catégorisation |
| **[Velyx-server](https://github.com/velyx-AI/Velyx-server)** | Backend avec synchronisation continue | Mises à jour de mémoire en temps réel, déclencheurs webhook |
| **[Velyx-ui](https://github.com/velyx-AI/Velyx-ui)** | Dashboard visuel de mémoire | Surveillance de l'évolution de la mémoire en direct |

**Liens Rapides:**
- 🚀 [Essayer Velyx Cloud](https://app.velyx.so/quick-start)
- 📚 [Documentation API](https://velyx.pro/docs)
- 💬 [Communauté Discord](https://discord.gg/velyx)
...
Pour commencer à contribuer à Velyx, vous devrez configurer votre environnement de développement:
...
- **GitHub Issues**: [Signaler des bugs & demander des fonctionnalités](https://github.com/velyx-AI/Velyx/issues)
- **Discord**: [Rejoindre la communauté](https://discord.com/invite/hQZntfGsbJ)
- **X (Twitter)**: [Suivre @velyx_ai](https://x.com/velyx_ai)
- **Contact**: info@velyx.ai
