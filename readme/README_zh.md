...
Velyx 是一个专为 **24/7 主动智能体**打造的记忆框架。
它专为长时间运行设计，能够大幅**降低保持智能体始终在线的 LLM token 成本**，使持续运行、不断进化的智能体在生产系统中变得切实可行。
Velyx **持续捕获并理解用户意图**。即使没有明确指令，智能体也能判断你即将要做什么并主动执行。
...
Velyx 将**记忆视为文件系统**——结构化、层次化、即时可访问。
...
正如文件系统将原始字节转化为有组织的数据，Velyx 将原始交互转化为**结构化、可搜索、主动式的智能**。
...
如果你觉得 Velyx 有用或有趣，请给项目点个星 ⭐️，这将是对我们最大的支持！
...
Velyx 的三层系统同时支持**响应式查询**和**主动上下文加载**：
...
👉 **[velyx.so](https://velyx.so)** - 提供 7×24 持续学习的托管服务

如需具有自定义主动工作流的企业部署，请联系 **info@velyx.ai**

#### 云 API (v3)

| 基础 URL | `https://api.velyx.so` |
|----------|----------------------|
...
📚 **[完整 API 文档](https://velyx.pro/docs#cloud-version)**
...
Velyx 支持 OpenAI 以外的自定义 LLM 和嵌入提供者。通过 `llm_profiles` 配置：
```python
...
Velyx 支持 [OpenRouter](https://openrouter.ai) 作为模型提供者，让您通过单个 API 访问多个 LLM 提供者。
...
Velyx 在 Locomo 基准测试中，在所有推理任务上实现了 **92.09% 的平均准确率**，展示了可靠的主动记忆操作。

<img width="100%" alt="benchmark" src="https://github.com/user-attachments/assets/6fec4884-94e5-4058-ad5c-baac3d7e76d9" />

查看详细实验数据：[Velyx-experiment](https://github.com/velyx-AI/Velyx-experiment)
...
| 仓库 | 描述 | 主动功能 |
|------|------|----------|
| **[Velyx](https://github.com/velyx-AI/Velyx)** | 核心主动记忆引擎 | 7×24 学习管道、自动分类 |
| **[Velyx-server](https://github.com/velyx-AI/Velyx-server)** | 带持续同步的后端 | 实时记忆更新、webhook 触发 |
| **[Velyx-ui](https://github.com/velyx-AI/Velyx-ui)** | 可视化记忆仪表板 | 实时记忆演化监控 |

**快速链接：**
- 🚀 [试用 Velyx 云服务](https://app.velyx.so/quick-start)
- 📚 [API 文档](https://velyx.pro/docs)
- 💬 [Discord 社区](https://discord.gg/velyx)
...
- **GitHub Issues**：[报告错误和请求功能](https://github.com/velyx-AI/Velyx/issues)
- **Discord**：[加入社区](https://discord.com/invite/hQZntfGsbJ)
- **X (Twitter)**：[关注 @velyx_ai](https://x.com/velyx_ai)
- **联系方式**：info@velyx.ai
