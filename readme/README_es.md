...
Velyx es un framework de memoria construido para **agentes proactivos 24/7**.
...
Velyx **captura y comprende continuamente la intención del usuario**. Incluso sin un comando, el agente puede detectar lo que estás a punto de hacer y actuar por sí mismo.
...
Velyx trata la **memoria como un sistema de archivos**—estructurada, jerárquica e instantáneamente accesible.

| Sistema de Archivos | Memoria Velyx |
|--------------------|--------------|
...
Así como un sistema de archivos convierte bytes crudos en datos organizados, Velyx transforma interacciones crudas en **inteligencia estructurada, buscable y proactiva**.
...
Si encuentras Velyx útil o interesante, te agradeceríamos mucho una estrella en GitHub ⭐️.
...
Velyx rastrea: historial de lectura, artículos guardados, consultas de búsqueda
...
```python
# Velyx observa patrones de email con el tiempo:
...
```python
# Velyx aprende preferencias de trading:
...
El sistema de tres capas de Velyx permite tanto **consultas reactivas** como **carga proactiva de contexto**:
...
👉 **[velyx.so](https://velyx.so)** - Servicio hospedado con aprendizaje continuo 7×24

Para despliegue empresarial con flujos de trabajo proactivos personalizados, contacta **info@velyx.ai**

#### API en la Nube (v3)

| URL Base | `https://api.velyx.so` |
|----------|----------------------|
...
📚 **[Documentación Completa de API](https://velyx.pro/docs#cloud-version)**
...
Velyx soporta proveedores personalizados de LLM y embeddings más allá de OpenAI. Configúralos via `llm_profiles`:
```python
...
Velyx soporta [OpenRouter](https://openrouter.ai) como proveedor de modelos, dándote acceso a múltiples proveedores de LLM a través de una sola API.
...
Velyx soporta tanto **carga proactiva de contexto** como **consultas reactivas**:
...
Velyx alcanza **92.09% de precisión promedio** en el benchmark Locomo en todas las tareas de razonamiento, demostrando operaciones confiables de memoria proactiva.

<img width="100%" alt="benchmark" src="https://github.com/user-attachments/assets/6fec4884-94e5-4058-ad5c-baac3d7e76d9" />

Ver datos experimentales detallados: [Velyx-experiment](https://github.com/velyx-AI/Velyx-experiment)
...
|-------------|-------------|---------------------------|
| **[Velyx](https://github.com/velyx-AI/Velyx)** | Motor principal de memoria proactiva | Pipeline de aprendizaje 7×24, auto-categorización |
| **[Velyx-server](https://github.com/velyx-AI/Velyx-server)** | Backend con sincronización continua | Actualizaciones de memoria en tiempo real, triggers de webhook |
| **[Velyx-ui](https://github.com/velyx-AI/Velyx-ui)** | Dashboard visual de memoria | Monitoreo de evolución de memoria en vivo |

**Enlaces Rápidos:**
- 🚀 [Probar Velyx Cloud](https://app.velyx.so/quick-start)
- 📚 [Documentación de API](https://velyx.pro/docs)
- 💬 [Comunidad Discord](https://discord.gg/velyx)
...
Para empezar a contribuir a Velyx, necesitarás configurar tu entorno de desarrollo:
...
- **GitHub Issues**: [Reportar bugs y solicitar características](https://github.com/velyx-AI/Velyx/issues)
- **Discord**: [Unirse a la comunidad](https://discord.com/invite/hQZntfGsbJ)
- **X (Twitter)**: [Seguir @velyx_ai](https://x.com/velyx_ai)
- **Contacto**: info@velyx.ai
