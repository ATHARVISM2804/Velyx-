"""Unit tests for Velyx LangGraph integration."""
...
from velyx.app.service import MemoryService  # noqa: E402
from velyx.integrations.langgraph import velyxLangGraphTools  # noqa: E402
...
async def test_adapter_initialization(mock_memory_service):
    ...
    adapter = velyxLangGraphTools(mock_memory_service)
    tools = adapter.tools()
