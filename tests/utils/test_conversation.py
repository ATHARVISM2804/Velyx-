...
from velyx.utils.conversation import format_conversation_for_preprocess  # type: ignore[import-untyped]


class TestFormatConversationForPreprocess:
    """
    Test suite for format_conversation_for_preprocess function in src/velyx/utils/conversation.py.
