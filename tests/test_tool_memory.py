...
# Add src to path for direct import - MUST be before any velyx imports
...
spec = importlib.util.spec_from_file_location("models", src_path / "velyx" / "database" / "models.py")
...
util_tool_spec = importlib.util.spec_from_file_location("util_tool", src_path / "velyx" / "utils" / "tool.py")
