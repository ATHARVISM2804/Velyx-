...
class velyxChat:
    ...
    def __init__(
        ...
        self.completions = velyxChatCompletions(
...
class velyxOpenAIWrapper:
    ...
    def __init__(
        ...
        Args:
            ...
            service: Velyx MemoryService instance
...
def wrap_openai(
    ...
    return velyxOpenAIWrapper(client, service, user_data, ranking, top_k)
