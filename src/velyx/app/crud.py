...
from velyx.database.models import MemoryCategory, MemoryType
from velyx.prompts.category_patch import CATEGORY_PATCH_PROMPT
...
if TYPE_CHECKING:
    ...
    from velyx.app.settings import PatchConfig
