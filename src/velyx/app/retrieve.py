...
from velyx.database.inmemory.vector import cosine_topk
from velyx.prompts.retrieve.llm_category_ranker import PROMPT as LLM_CATEGORY_RANKER_PROMPT
from velyx.prompts.retrieve.llm_item_ranker import PROMPT as LLM_ITEM_RANKER_PROMPT
from velyx.prompts.retrieve.llm_resource_ranker import PROMPT as LLM_RESOURCE_RANKER_PROMPT
from velyx.prompts.retrieve.pre_retrieval_decision import SYSTEM_PROMPT as PRE_RETRIEVAL_SYSTEM_PROMPT
from velyx.prompts.retrieve.pre_retrieval_decision import USER_PROMPT as PRE_RETRIEVAL_USER_PROMPT
from velyx.workflow.step import WorkflowState, WorkflowStep

logger = logging.getLogger(__name__)

if TYPE_CHECKING:
    from velyx.app.service import Context
    from velyx.app.settings import RetrieveConfig
...
class RetrieveMixin:
    ...
    def _extract_referenced_item_ids(self, state: WorkflowState) -> set[str]:
        ...
        from velyx.utils.references import extract_references
