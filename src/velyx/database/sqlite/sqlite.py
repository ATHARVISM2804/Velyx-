"""SQLite database store implementation for Velyx."""
...
from velyx.database.models import CategoryItem, MemoryCategory, MemoryItem, Resource
...
from velyx.database.sqlite.schema import SQLiteSQLAModels, get_sqlite_sqlalchemy_models
from velyx.database.sqlite.session import SQLiteSessionManager
from velyx.database.state import DatabaseState
...
class SQLiteStore(Database):
    ...
    This store provides a lightweight, file-based database backend for Velyx.
