...
class LazyLLMClient:
    ...
    async def chat(
        ...
        *,
        ...
        """
        client = lazyllm.namespace("VELYX").OnlineModule(source=self.llm_source, model=self.chat_model, type="llm")
    ...
    async def vision(
        ...
        *,
        ...
        """
        client = lazyllm.namespace("VELYX").OnlineModule(source=self.vlm_source, model=self.vlm_model, type="vlm")
    ...
    async def embed(
        ...
        """
        client = lazyllm.namespace("VELYX").OnlineModule(
    ...
    async def transcribe(
        ...
        """
        client = lazyllm.namespace("VELYX").OnlineModule(source=self.stt_source, model=self.stt_model, type="stt")
