# Deploying Velyx on Sealos DevBox

This guide demonstrates how to build and deploy a **Personal AI Assistant with Long-Term Memory** using Velyx on [Sealos DevBox](https://sealos.io/products/devbox).

## Overview

Velyx enables AI agents to maintain persistent, structured memory across conversations. Combined with Sealos DevBox's 1-click cloud development environment, you can quickly build and deploy memory-enabled AI applications.

**What we'll build:**
- A FastAPI-based AI assistant that remembers user preferences and past conversations
- Persistent memory storage using Velyx's in-memory or PostgreSQL backend
...
mkdir velyx-assistant && cd velyx-assistant
...
pip install velyx fastapi uvicorn python-dotenv
```
...
Powered by Velyx + FastAPI on Sealos DevBox
"""
...
async def lifespan(app: FastAPI):
    ...
    print("✓ Velyx Memory Service initialized")
    yield
    print("Shutting down...")


app = FastAPI(
    title="Velyx Assistant",
...
```env
DATABASE_URL=postgresql://user:password@host:5432/velyx
```

4. Update `main.py` to use PostgreSQL backend (see Velyx documentation)
...
- **Persistent Memory**: Velyx maintains context across sessions
...
- [Velyx Documentation](https://github.com/velyx-AI/Velyx)
- [Sealos DevBox Guide](https://sealos.io/blog/how-to-setup-devbox)
- [FastAPI Documentation](https://fastapi.tiangolo.com)

---

*This guide was created for the Velyx PR Hackathon - 2026 New Year Challenge (Issue #228)*
