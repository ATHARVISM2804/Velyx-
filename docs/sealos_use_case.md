...
## Overview
This use case demonstrates how **Velyx** enables a support agent to remember user history across sessions, deployed on a **Sealos Devbox** environment.
...
- Python 3.13+
- Velyx Library (installed via `make install`)
