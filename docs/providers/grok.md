...
Velyx includes first-class support for [Grok](https://grok.x.ai/), allowing you to leverage xAI's powerful language models directly within your application.
...
When you select the `grok` provider, Velyx automatically configures the following defaults:
...
```python
from velyx.app.settings import LLMConfig
