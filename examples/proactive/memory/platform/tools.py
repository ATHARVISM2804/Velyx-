...
BASE_URL = "https://api.velyx.so"
API_KEY = "your velyx api key"
USER_ID = "claude_user"
AGENT_ID = "claude_agent"


@tool("velyx_memory", "Retrieve memory based on a query", {"query": str})
...
@tool("velyx_todos", "Retrieve todos for the user", {})
...
velyx_server = create_sdk_mcp_server(name="velyx", version="1.0.0", tools=[get_memory, get_todos])
