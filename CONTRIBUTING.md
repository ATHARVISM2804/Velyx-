...
Thank you for your interest in contributing to Velyx! This document provides guidelines and information for contributors.
...
- 🌐 **Translations** - Help make Velyx accessible globally
...
- **Environment details** (Python version, OS, Velyx version)
...
- Email security issues privately to [contact@velyx.ai](mailto:contact@velyx.ai)
- Include detailed reproduction steps and impact assessment
- We'll acknowledge receipt within 24 hours

## 📄 License and Attribution

By contributing to Velyx, you agree that:
...
| Channel | Best For |
|---------|----------|
| 💬 [Discord](https://discord.gg/velyx) | Real-time chat, quick questions |
| 🗣️ [GitHub Discussions](https://github.com/velyx-AI/Velyx/discussions) | Feature discussions, Q&A |
| 🐛 [GitHub Issues](https://github.com/velyx-AI/Velyx/issues) | Bug reports, feature requests |
| 📧 [Email](mailto:contact@velyx.ai) | Private inquiries |
...
- Our [Contributors](https://github.com/velyx-AI/Velyx/graphs/contributors) page

Thank you for helping make Velyx better! 🚀
